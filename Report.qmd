...
To check goodness of fit, we plotted Pearson residuals over time. We appear to minimize residuals over time in the mixture model, as seen in Figure 2. Putting this together, we concluded that the binomial mixture model is the best fit (*see: Figure 2*).
