...
reform_phase_data |>
  ...
  geom_point(size = 2) +
    labs(
      ...
      caption = str_wrap("Figure 1: Internal medicine resident exam pass rate over time periods for no reform (1996-2002), phasing in reform one (2003-2005), reform one (2006-2010), phasing in reform two (2011-2013), and reform two (2014-2015).", width = 80)
    ) + 
